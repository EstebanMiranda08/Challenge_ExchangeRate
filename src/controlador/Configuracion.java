...
public class Configuracion {
    ...
    public static Divisas conversorDivisa(String divisaInicial, String divisaFinal, int valor_join) throws IOException, InterruptedException {
        ...
        String key_base= verificar_map(divisaInicial);
        String key_conversor=verificar_map(divisaFinal);

        if (key_base.equals("Error")&& key_conversor.equals("Error")){
            return  null;
        }
        else{
            return ConversorApi.conversorDivisa(key_base,key_conversor, valor_join);
        }
